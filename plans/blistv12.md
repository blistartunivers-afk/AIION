...
```bash
/plan check blistv12 F1.1 done      # marca como completado ✅
/plan check blistv12 F1.1 partial   # en progreso 🔄
/plan check blistv12 F1.1 pending   # pendiente ⏳
/plan show blistv12                 # ver plan completo
```

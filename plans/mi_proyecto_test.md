...
```bash
/plan check mi_proyecto_test F1.1 done      # marca como completado ✅
/plan check mi_proyecto_test F1.1 partial   # en progreso 🔄
/plan check mi_proyecto_test F1.1 pending   # pendiente ⏳
/plan show mi_proyecto_test                 # ver plan completo
```

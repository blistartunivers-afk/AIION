...
```bash
/plan check nuevo_plan F1.1 done      # marca como completado ✅
/plan check nuevo_plan F1.1 partial   # en progreso 🔄
/plan check nuevo_plan F1.1 pending   # pendiente ⏳
/plan show nuevo_plan                 # ver plan completo
```

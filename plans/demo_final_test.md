...
```bash
/plan check demo_final_test F1.1 done      # marca como completado ✅
/plan check demo_final_test F1.1 partial   # en progreso 🔄
/plan check demo_final_test F1.1 pending   # pendiente ⏳
/plan show demo_final_test                 # ver plan completo
```

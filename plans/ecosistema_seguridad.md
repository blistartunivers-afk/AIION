...
```bash
/plan check ecosistema_seguridad F1.1 done      # marca como completado ✅
/plan check ecosistema_seguridad F1.1 partial   # en progreso 🔄
/plan check ecosistema_seguridad F1.1 pending   # pendiente ⏳
/plan show ecosistema_seguridad                 # ver plan completo
```
